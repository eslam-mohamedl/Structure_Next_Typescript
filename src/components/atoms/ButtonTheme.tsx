...
function ThemeToggle() {
  ...
  return (
    <button
      ...
      className={`relative flex h-11 w-21 cursor-pointer items-center rounded-full p-1 transition-colors duration-500 md:h-9 md:w-18 ${theme === "dark" ? "bg-primary" : "bg-gray-300"} shadow-md hover:scale-105`}
